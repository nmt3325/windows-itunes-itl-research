...
- The corpus contains exactly **two** distinct values:
  - 95 bytes, 54 snapshots:
    `file://localhost/D:/a/_temp/gha-mcp/win-48e85eyn/work/itl/fixtures/dynamic/live/iTunes%20Media/`
  - 66 bytes, only `000-empty.itl`:
    `file://localhost/C:/Users/runneradmin/Music/iTunes/iTunes%20Media/`
