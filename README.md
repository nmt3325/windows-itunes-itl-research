...
- [`corpus-manifest.json`](corpus-manifest.json) hashes all 309 retained ITLs and links the nested reference, fresh-native, path/time, smart-playlist, reference-generation, media-field, Lyrics-authority, and Lyrics-boundary analyses. The four checked-in one-track/three-track reference fixtures are `verified` only for their pinned hashes.
...
- Eleven additional fresh MP3 cases passed all four sessions: one Unicode value and ASCII lengths 255, 256, 1,024, 4,096, 8,192, 16,384, 32,767, 32,768, 65,535, and 65,536. The exact 65,536-character pass is a measured lower accepted point, not an upper boundary. See [`evidence/native/media-lyrics-boundary-20260922/README.md`](evidence/native/media-lyrics-boundary-20260922/README.md) and [`evidence/native/media-lyrics-extended-boundary-20260922/README.md`](evidence/native/media-lyrics-extended-boundary-20260922/README.md).
