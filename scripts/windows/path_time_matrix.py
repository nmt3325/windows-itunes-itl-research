...
def _authenticode(path: Path) -> dict:
    # PowerShell treats tokens following -Command as source tokens. Embed an
    # escaped literal so paths containing spaces cannot be split or re-parsed.
    ...
    command = ["pwsh", "-NoLogo", "-NoProfile", "-Command", script]
