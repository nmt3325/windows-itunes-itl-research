...
_args=_parser.parse_args();ROOT=_args.root.resolve();R=(_args.output_dir or ROOT/'reports/static').resolve();R.mkdir(parents=True,exist_ok=True)
import pefile
...
binpath=_args.binary.resolve();sha=hashlib.sha256(binpath.read_bytes()).hexdigest();assert sha=='30d91209b5d81c47bbad2da9d89764fcab08bf5cd9af1a9571668001376c5d7d'
