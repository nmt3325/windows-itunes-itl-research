...
def build_corpus() -> dict:
    ...
    return {
        ...
        "qualification": {
            ...
            "media_field_followup_note": "first run failed a harness identity gate before mutation; corrected WAV cases retain three exact mutation failures; 12 exact MP3 Lyrics cases passed mutation/restart, including one Unicode value and ASCII through 65,536 characters; 65,536 is a lower accepted point, not an upper boundary",
