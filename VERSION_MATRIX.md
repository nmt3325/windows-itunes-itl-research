...
| --- | --- | --- | --- | --- | --- | --- |
| Standalone Windows iTunes 12.13.10.3, x64, observed LE profile | Implemented and offline-tested; native flag variants observed | Implemented for modeled sections/records | Guarded 756-byte `mith` subset, including bounded Name/Unplayed behavior | Guarded ordinary playlists and closed local-WAV track operations | Extensive exact-candidate evidence, including two-cycle writer gates | **Primary supported research profile** |
