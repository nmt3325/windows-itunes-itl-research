...
| Native COM `Lyrics` setter (not an `itlkit` write API) | Three exact WAV failures; 12 exact MP3 passes including one Unicode value and ASCII through 65,536; no upper boundary | Unqualified | Unqualified |
