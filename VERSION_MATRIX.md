...
13. **Media-backed field negative:** [`evidence/native/media-field-followup-20260922-v2/summary.json`](evidence/native/media-field-followup-20260922-v2/summary.json) records successful fresh-WAV initialization and baseline restart for both cases, followed by the exact Lyrics COM exception and `Enabled=false` immediate readback of `true`. The preceding [`media-field-followup-20260922`](evidence/native/media-field-followup-20260922/README.md) run failed a harness identity assertion before any setter. Neither cohort adds a supported version or general field-rejection rule.
